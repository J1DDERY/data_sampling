...
#
# Generated by Vivado on Tue Jun 18 21:24:06 CEST 2024
...
#    "./srcs/sources_1/SDP_RAM_32x16b.vhd"
#    "./srcs/sources_1/sample_encoder_32_32.vhd"
#    "./srcs/sources_1/dig_pattern_gen.vhd"
...
#    "./srcs/sources_1/sample_encoder_32_32_tb.vhd"
#    "./srcs/sources_1/sample_encoder_32_32_tb_behav.wcfg"
#    "./srcs/sources_1/dig_pattern_gen_tb.vhd"
...
#    "./srcs/sources_1/LA_core_tb.vhdl"
#    "./srcs/sources_1/dig_pattern_gen_tb.vhd"
#    "./srcs/sources_1/dig_pattern_gen_tb_behav.wcfg"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/srcs/sources_1/SDP_RAM_32x16b.vhd"]"\
 "[file normalize "$origin_dir/srcs/sources_1/sample_encoder_32_32.vhd"]"\
 "[file normalize "$origin_dir/srcs/sources_1/dig_pattern_gen.vhd"]"\
 ...
 "[file normalize "$origin_dir/srcs/constrs_1/io_loc.xdc"]"\
 "[file normalize "$origin_dir/srcs/constrs_1/timing.xdc"]"\
 "[file normalize "$origin_dir/srcs/constrs_1/bitstream.xdc"]"\
 "[file normalize "$origin_dir/srcs/sources_1/sample_encoder_32_32_tb.vhd"]"\
 "[file normalize "$origin_dir/srcs/sources_1/sample_encoder_32_32_tb_behav.wcfg"]"\
 "[file normalize "$origin_dir/srcs/sources_1/dig_pattern_gen_tb.vhd"]"\
 ...
 "[file normalize "$origin_dir/srcs/sources_1/LA_core_tb.vhdl"]"\
 "[file normalize "$origin_dir/srcs/sources_1/dig_pattern_gen_tb.vhd"]"\
 "[file normalize "$origin_dir/srcs/sources_1/dig_pattern_gen_tb_behav.wcfg"]"\
  ]
  foreach ifile $files {
...
set_property -name "webtalk.activehdl_export_sim" -value "86" -objects $obj
set_property -name "webtalk.ies_export_sim" -value "82" -objects $obj
set_property -name "webtalk.modelsim_export_sim" -value "86" -objects $obj
set_property -name "webtalk.questa_export_sim" -value "86" -objects $obj
set_property -name "webtalk.riviera_export_sim" -value "86" -objects $obj
set_property -name "webtalk.vcs_export_sim" -value "86" -objects $obj
set_property -name "webtalk.xsim_export_sim" -value "86" -objects $obj
set_property -name "webtalk.xsim_launch_sim" -value "2457" -objects $obj
...
set file "$origin_dir/srcs/sources_1/SDP_RAM_32x16b.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/srcs/sources_1/sample_encoder_32_32.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/srcs/sources_1/dig_pattern_gen.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "$origin_dir/srcs/sources_1/sample_encoder_32_32_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/srcs/sources_1/dig_pattern_gen_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "sample_encoder_32_32_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
# Create 'LA_core_test' fileset (if not found)
if {[string equal [get_filesets -quiet LA_core_test] ""]} {
  create_fileset -simset LA_core_test
}

# Set 'LA_core_test' fileset object
set obj [get_filesets LA_core_test]
set files [list \
 [file normalize "${origin_dir}/srcs/sources_1/LA_core_tb.vhdl"] \
]
add_files -norecurse -fileset $obj $files

# Set 'LA_core_test' fileset file properties for remote files
set file "$origin_dir/srcs/sources_1/LA_core_tb.vhdl"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets LA_core_test] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj


# Set 'LA_core_test' fileset file properties for local files
# None

# Set 'LA_core_test' fileset properties
set obj [get_filesets LA_core_test]
set_property -name "top" -value "LA_core_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_lib" -value "xil_defaultlib" -objects $obj

# Create 'dig_pattern_gen' fileset (if not found)
if {[string equal [get_filesets -quiet dig_pattern_gen] ""]} {
  create_fileset -simset dig_pattern_gen
}

# Set 'dig_pattern_gen' fileset object
set obj [get_filesets dig_pattern_gen]
set files [list \
 [file normalize "${origin_dir}/srcs/sources_1/dig_pattern_gen_tb.vhd"] \
 [file normalize "${origin_dir}/srcs/sources_1/dig_pattern_gen_tb_behav.wcfg"] \
]
...
# Set 'dig_pattern_gen' fileset file properties for remote files
set file "$origin_dir/srcs/sources_1/dig_pattern_gen_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets dig_pattern_gen] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj


# Set 'dig_pattern_gen' fileset file properties for local files
# None

# Set 'dig_pattern_gen' fileset properties
set obj [get_filesets dig_pattern_gen]
set_property -name "top" -value "dig_pattern_gen_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_lib" -value "xil_defaultlib" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a35tftg256-2 -flow {Vivado Synthesis 2022} -strategy "Flow_PerfOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a35tftg256-2 -flow {Vivado Implementation 2022} -strategy "Performance_RefinePlacement" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
