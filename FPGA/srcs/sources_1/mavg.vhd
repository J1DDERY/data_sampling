...
signal r_acc  : signed(DATA_WIDTH+MAX_MAVG_LEN_LOG-1 downto 0);  -- average accumulator
...
--            p_mavg <= (others=>(others=>'0'));
        ...
        o_data <= std_logic_vector(r_acc(DATA_WIDTH+mavg_len_log-1 downto mavg_len_log));  -- divide by 2^mavg_len
    end if;
