...
set_property PACKAGE_PIN M14 [get_ports {data_p[3]}]
set_property PACKAGE_PIN L14 [get_ports {data_n[3]}]
set_property PACKAGE_PIN L13 [get_ports {data_p[4]}]
set_property PACKAGE_PIN K13 [get_ports {data_n[4]}]
set_property PACKAGE_PIN R15 [get_ports {data_p[5]}]
set_property PACKAGE_PIN R16 [get_ports {data_n[5]}]
set_property PACKAGE_PIN T15 [get_ports {data_p[6]}]
set_property PACKAGE_PIN T14 [get_ports {data_n[6]}]
...
set_property PACKAGE_PIN N16 [get_ports {data_p[9]}]
set_property PACKAGE_PIN M16 [get_ports {data_n[9]}]
set_property PACKAGE_PIN N9 [get_ports {data_p[10]}]
set_property PACKAGE_PIN P9 [get_ports {data_n[10]}]
set_property PACKAGE_PIN N6 [get_ports {data_p[11]}]
set_property PACKAGE_PIN M6 [get_ports {data_n[11]}]
...
#debug digital output pattern control
#create_debug_core u_ila_0 ila
#set_property ALL_PROBE_SAME_MU true [get_debug_cores u_ila_0]
#set_property ALL_PROBE_SAME_MU_CNT 1 [get_debug_cores u_ila_0]
#set_property C_ADV_TRIGGER false [get_debug_cores u_ila_0]
...
#connect_debug_port u_ila_0/probe0 [get_nets [list {cfg_addrB[0]} {cfg_addrB[1]} {cfg_addrB[2]} {cfg_addrB[3]} {cfg_addrB[4]} {cfg_addrB[5]}]]
#create_debug_port u_ila_0 probe
#set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
#set_property port_width 15 [get_debug_ports u_ila_0/probe1]
#connect_debug_port u_ila_0/probe1 [get_nets [list {dig_pattern_gen_0/addrb_dig_i[0]} {dig_pattern_gen_0/addrb_dig_i[1]} {dig_pattern_gen_0/addrb_dig_i[2]} {dig_pattern_gen_0/addrb_dig_i[3]} {dig_pattern_gen_0/addrb_dig_i[4]} {dig_pattern_gen_0/addrb_dig_i[5]} {dig_pattern_gen_0/addrb_dig_i[6]} {dig_pattern_gen_0/addrb_dig_i[7]} {dig_pattern_gen_0/addrb_dig_i[8]} {dig_pattern_gen_0/addrb_dig_i[9]} {dig_pattern_gen_0/addrb_dig_i[10]} {dig_pattern_gen_0/addrb_dig_i[11]} {dig_pattern_gen_0/addrb_dig_i[12]} {dig_pattern_gen_0/addrb_dig_i[13]} {dig_pattern_gen_0/addrb_dig_i[14]}]]
#create_debug_port u_ila_0 probe
#set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
#set_property port_width 1 [get_debug_ports u_ila_0/probe2]
#connect_debug_port u_ila_0/probe2 [get_nets [list dig_pattern_gen_0/digitalPatternOutputEn_dd]]
#create_debug_port u_ila_0 probe
#set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
#set_property port_width 1 [get_debug_ports u_ila_0/probe3]
#connect_debug_port u_ila_0/probe3 [get_nets [list dig_pattern_gen_0/digitalPatternOutputMode_dd]]
#create_debug_port u_ila_0 probe
#set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
#set_property port_width 1 [get_debug_ports u_ila_0/probe4]
#connect_debug_port u_ila_0/probe4 [get_nets [list dig_pattern_gen_0/digitalPatternOutputRestart_dd]]
#create_debug_port u_ila_0 probe
#set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe5]
#set_property port_width 1 [get_debug_ports u_ila_0/probe5]
#connect_debug_port u_ila_0/probe5 [get_nets [list reading_config_registers_dd]]
#set_property C_CLK_INPUT_FREQ_HZ 300000000 [get_debug_cores dbg_hub]
#set_property C_ENABLE_CLK_DIVIDER false [get_debug_cores dbg_hub]
#set_property C_USER_SCAN_CHAIN 1 [get_debug_cores dbg_hub]
#connect_debug_port dbg_hub/clk [get_nets clk_adc_dclk]
